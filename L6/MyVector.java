/*
	...
	Koniec wektora oznacza się za pomocą wciśnięcia klawisza enter.
	
	Jeżeli podany ciąg nie jest liczbą, jest ignorowany.
	
	Następnie należy spróbować dodać wektory, jeżeli są równej długości (są równej
	...
	(należy tak skonstruować wyjątek, aby możliwe było skonstruowanie
	...
	Jeżeli są równej długości, wynik dodawania zapisywany jest do pliku.
